local mod = "SUPER"
local windows = require("modules.window_controls")
...
hl.bind(K(mod .. " + A"),         windows.toggle_float) -- float at 1000x660, centred (press again to restore tiling)
hl.bind(K(mod .. " + ALT + F"),   windows.toggle_width) -- toggle full column width (scrolling layout)
...
hl.bind(K("ALT + Tab"),              hl.dsp.window.cycle_next({ next = true }))    -- cycle to next window
hl.bind(K("ALT + SHIFT + Tab"),      hl.dsp.window.cycle_next({ next = false }))   -- cycle to previous window
hl.bind(K(mod .. " + SHIFT + mouse_up"),   function() windows.focus(-1) end) -- focus column left (scrolling layout)
hl.bind(K(mod .. " + SHIFT + mouse_down"), function() windows.focus(1) end)  -- focus column right (scrolling layout)
...
hl.bind(K(mod .. " + CTRL + Left"),   function() windows.resize(-1) end, { repeating = true }) -- resize window narrower
hl.bind(K(mod .. " + CTRL + Right"),  function() windows.resize(1) end, { repeating = true })  -- resize window wider
